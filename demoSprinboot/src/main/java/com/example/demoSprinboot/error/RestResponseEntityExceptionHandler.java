...
import com.example.demoSprinboot.Model.ErrorModel.ErrorMessage;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /*Aspect-oriented Programming concept Expect Oriented programming concept that is define the Advice
     for the  controller */
